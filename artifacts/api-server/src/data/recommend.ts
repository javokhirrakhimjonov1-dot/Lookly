...
export interface RecommendationRequest { items:StoredWardrobeItem[]; weather:WeatherProviderResponse; user?:Partial<UserProfile>&{userGender?:string;userAge?:number;styleAesthetics?:string[];colorPalette?:string}; topN?:number; }
