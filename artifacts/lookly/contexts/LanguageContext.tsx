...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    feature_squad_votes_desc: "Send a look to friends and get their honest votes.",
    feature_premium_try_on: "Premium AI try-on",
    feature_premium_try_on_desc: "See a realistic preview of your outfit on a model.",
  ...
  ru: {
    ...
    feature_squad_votes_desc: "Отправьте образ друзьям и получите их честные голоса.",
    feature_premium_try_on: "Премиум ИИ-примерка",
    feature_premium_try_on_desc: "Посмотрите реалистичное превью образа на модели.",
  ...
  uz: {
    ...
    feature_squad_votes_desc: "Ko'rinishingizni do'stlaringizga yuboring va ularning halol ovozlarini oling.",
    feature_premium_try_on: "Premium AI kiyib ko'rish",
    feature_premium_try_on_desc: "Kiyimingiz modelda qanday ko'rinishini realistik tarzda ko'ring.",
